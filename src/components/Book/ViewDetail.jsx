                    ...
                    {dataBook && dataBook._id ?
                        <Row gutter={[20, 20]}>
                            ...
                            <Col md={14} sm={24}>
                                ...
                                <Col span={24}>
                                    <div className='author'>Tác giả: {dataBook.author}<a href='#'></a> </div>
                                    ...
                                    <div className='delivery'>
                                        <div>
                                            <span className='left-slide'>Vận chuyển</span>
                                            <span className='right-slide'>Miễn phí vận chuyển</span>
                                        </div>
                                    </div>
                                    <div className='quantity'>
                                        <span className='left-slide'>Số lượng</span>
